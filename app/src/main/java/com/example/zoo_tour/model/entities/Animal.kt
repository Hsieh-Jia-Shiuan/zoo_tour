...
data class Animal(
    ...
    @SerializedName("a_poigroup") val aPioGroup: String,
    ...
    @SerializedName("a_theme_name") val aThemeName: String,
    @SerializedName("a_theme_url") val aThemeUrl: String,
    @SerializedName("a_adopt") val aAdopt: String,
    @SerializedName("a_code") val aCode: String?,
    @SerializedName("a_pic01_alt") val aPic01Alt: String,
    @SerializedName("a_pic01_url") val aPic01Url: String?,
    @SerializedName("a_pic02_alt") val aPic02Alt: String,
    @SerializedName("a_pic02_url") val aPic02Url: String?,
    @SerializedName("a_pic03_alt") val aPic03Alt: String,
    @SerializedName("a_pic03_url") val aPic03Url: String?,
    @SerializedName("a_pic04_alt") val aPic04Alt: String,
    @SerializedName("a_pic04_url") val aPic04Url: String?,
    @SerializedName("a_pdf01_alt") val apdf01Alt: String,
    @SerializedName("a_pdf01_url") val apdf01Url: String?,
    @SerializedName("a_pdf02_alt") val apdf02Alt: String,
    @SerializedName("a_pdf02_url") val apdf02Url: String?,
    @SerializedName("a_voice01_alt") val aVoice01Alt: String,
    @SerializedName("a_voice01_url") val aVoice01Url: String?,
    @SerializedName("a_voice02_alt") val aVoice02Alt: String,
    @SerializedName("a_voice02_url") val aVoice02Url: String?,
    @SerializedName("a_voice03_alt") val aVoice03Alt: String,
    @SerializedName("a_voice03_url") val aVoice03Url: String?,
    @SerializedName("a_vedio_url") val aVedioUrl: String?,
